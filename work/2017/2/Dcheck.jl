...
function orderMatches(matches,deps,S,T)
    ...
    function checks(s,t)
        while 1 << (deps[s][walkIdx[s]]-1) | currentTurrets == currentTurrets; walkIdx[s] += 1; end
