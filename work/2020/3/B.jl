...
function solveSmall(K::Int64,N::Int64,X::Vector{Int64},T::Vector{Int64})
    npts = 2K
    best = npts
    base::Vector{Int64} = fill(0,2K)
    keepout::Vector{Bool} = fill(false,2K)
    working::Vector{Int64} = fill(0,2K)
...
function dofullloop(N::Int64,segleft::Vector{Int64},segright::Vector{Int64},
    segwidths::Vector{Int64},singleOK::Vector{Bool})::Bool
...
function dotraverse(st::Int64,en::Int64,checkfull::Bool,
                    N::Int64,segleft::Vector{Int64},segright::Vector{Int64},
                    segwidths::Vector{Int64},singleOK::Vector{Bool})::Int64
...
function solveLarge(K::Int64,N::Int64,X::Vector{Int64},T::Vector{Int64})
    segwidths::Vector{Int64} = fill(0,N)
    segleft::Vector{Int64} = fill(0,N)
    segright::Vector{Int64} = fill(0,N)
    singleOK::Vector{Bool} = fill(true,N)
