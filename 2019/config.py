...
if __name__ == "__main__" :
    clargs = parseCLArgs()
    probList = [
            "Qual_ForegoneSolution",
            "Qual_YouCanGoYourOwnWay",
            "Qual_Cryptoangrams",
            "Qual_DatBae",
            "1A_Pylons",
            "1A_GolfGophers",
            "1A_AlienRhyme",
            "1B_ManhattanCrepeCart",
            "1B_Draupnir",
            "1B_FairFight",
            "1C_RobotProgrammingStrategy",
            "1C_PowerArrangers",
            "1C_BacterialTactics",
            "2_NewElementsPart1",
            "2_PotteryLottery",
            ...
            "3_NapkinFolding",
            "WF_BoardMeeting",
            "WF_SortingPermutationUnit",
            "WF_WontSumMustNow",
            "WF_JuggleStrugglePart1",
            "WF_JuggleStrugglePart2",
            "WF_GoToConsideredHelpful",
            ]
